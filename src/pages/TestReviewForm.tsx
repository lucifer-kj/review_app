...
export default function TestReviewForm() {
  ...
  useEffect(() => {
    const fetchTenantData = async () => {
      ...
      try {
        ...
        // Try to fetch tenant data directly
    ...
    fetchTenantData();
  }, [tenantId, sanitizedUtmParams.customerName]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!tenantData) {
      toast({
        title: "Error",
        description: "Invalid tenant data. Please contact support.",
        variant: "destructive",
      });
      setIsSubmitting(false);
      return;
    ...
    try {
      ...
      const { data: insertedData, error } = await supabase
        ...
        .insert({
          ...
          metadata: {
            source: sanitizedUtmParams.utmSource || 'test_review_form',
        ...
        <div className="text-center max-w-md mx-auto p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              The review link is missing the tenant identifier. Please check the URL and try again.
            </p>
  ...
  if (error || !tenantData) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <h2 className="text-2xl font-bold text-red-600 mb-4">Review Form Not Available</h2>
            <p className="text-gray-600 mb-4">
              {error || 'The review form is currently unavailable. Please try again later.'}
            </p>
          ...
          <CardHeader className="text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <div>
                ...
                {tenantData.domain && (
                  <p className="text-sm text-gray-500">{tenantData.domain}</p>
                )}
              </div>
            </div>
            <CardDescription className="text-lg">
              Share your experience with {tenantData.name}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium">
                  ...
                  How would you rate your experience with {tenantData.name}? *
                </Label>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder={`Tell us more about your experience with ${tenantData.name}...`}
                  rows={4}
                  className="text-base"
                />
              </div>
